...
class MockPluginTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $plugin = new MockPlugin();
        $plugin->addResponse(\Illuminate\Support\Facades\Response::fromMessage("HTTP/1.1 200 OK\r\nContent-Length: 0\r\n\r\n"));
    ...
    {
        $p = new MockPlugin();
        $response = \Illuminate\Support\Facades\Response::fromMessage("HTTP/1.1 200 OK\r\nContent-Length: 0\r\n\r\n");
