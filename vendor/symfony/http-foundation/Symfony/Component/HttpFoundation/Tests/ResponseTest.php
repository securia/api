...
class ResponseTest extends ResponseTestCase
{
    ...
    {
        $response = \Illuminate\Support\Facades\Response::create('foo', 301, array('Foo' => 'bar'));
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('/homepage', 'POST');
    ...
    {
        $response = new Response('foo');
        $request = \Illuminate\Support\Facades\Request::create('/', 'HEAD');
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('/', 'GET');
