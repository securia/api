...
class RequestStackTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetMasterRequest()
    {
        ...
        $masterRequest = \Illuminate\Support\Facades\Request::create('/foo');
        $subRequest = \Illuminate\Support\Facades\Request::create('/bar');
    ...
    public function testGetParentRequest()
    {
        ...
        $firstSubRequest = \Illuminate\Support\Facades\Request::create('/bar');

        $requestStack->push($firstSubRequest);
        $this->assertSame($masterRequest, $requestStack->getParentRequest());

        $secondSubRequest = \Illuminate\Support\Facades\Request::create('/baz');
