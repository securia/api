...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('http://user_test:password_test@test.com/');
        $user = $request->getUser();

        $this->assertEquals('user_test', $user);
    }

    public function testGetPasswor \Illuminate\Support\Facades\Request::        $request = \Illuminate\Support\Facades\Request::create('http://user_test:password_test@test.com/');
     ...
     */
  \Illuminate\Support\Facades\Request::function testCreate()
    {
        $request = \Illuminate\Support\Facades\Request::create('http://test.com/foo?bar=baz');
        $this->assertEquals('http://test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEquals('test.com', $request->g \Illuminate\Support\Facades\Request::());
        $this->assertFalse($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('http://test.com/foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('http://test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEq \Illuminate\Support\Facades\Request::.com', $request->getHttpHost());
        $this->assertFalse($request->isSecure());
        ...
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort \Illuminate\Support\Facades\Request::   $this->assertEquals('test.com', $request->getHttpHost());
        $this->assertFalse($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('https://test.com/foo?bar=baz');
        $this->assertEquals('https://test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assert \Illuminate\Support\Facades\Request::, $request->getPort());
        $this->assertEquals('test.com', $request->getHttpHost());
        $this->assertTrue($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('test.com:90/foo');
        $this->assertEquals('http://test.com:90/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('test.com', $request->getHost( \Illuminate\Support\Facades\Request::  $this->assertEquals('test.com:90', $request->getHttpHost());
        $this->assertEquals(90, $request->getPort());
        $this->assertFalse($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('https://test.com:90/foo');
        $this->assertEquals('https://test.com:90/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals(' \Illuminate\Support\Facades\Request:: $request->getHost());
        ...
        $this->assertEquals('/foo', $request->getPathInfo());
    \Illuminate\Support\Facades\Request::->assertEquals('127.0.0.1', $request->getHost());
        $this->assertEquals('127.0.0.1:90', $request->getHttpHost());
        $this->assertEquals(90, $request->getPort());
        $this->assertTrue($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('https://[::1]:90/foo');
        $this->assertEquals('https://[::1]:90/foo', $request->getUri());
        $this->assertEquals(' \Illuminate\Support\Facades\Request::quest->getPathInfo());
        ...
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertE \Illuminate\Support\Facades\Request::1]', $request->getHost());
        $this->assertEquals('[::1]', $request->getHttpHost());
        $this->assertEquals(443, $request->getPort());
        $this->assertTrue($request->isSecure( \Illuminate\Support\Facades\Request::   $json = '{"jsonrpc":"2.0","method":"echo","id":7,"params":["Hello World"]}';
        $request = Request::create('http://example.com/jsonrpc', 'POST', array(), array(), array(), array(), $json);
        $this->assertEquals($json, $request->getContent());
        $this->assertFalse($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('http://test.com');
        $this- \Illuminate\Support\Facades\Request::als('http://test.com/', $request->getUri());
        ...
        $request = \Illuminate\Support\Facades\Request::create('http://test.com?test=1'); \Illuminate\Support\Facades\Request::this->assertEquals('http://test.com/?test=1', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        ...
        $request = \Illuminate\Support\Facades\Request::create('http:// \Illuminate\Support\Facades\Request::0/?test=1');
        ...
        $request = \Illuminate\Support\Facades\Request::create('http://username:password@test.com');
        $this->assertEquals('http://test.com/', $request-> \Illuminate\Support\Facades\Request::
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEquals('test.com', $request->getHttpHost());
        ...
        $request = \Illuminate\Support\Facades\Request::create('http://username@test.com');
        $this->asser \Illuminate\Support\Facades\Request::ttp://test.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEquals('test.com', $request- \Illuminate\Support\Facades\Request::st());
        $this->assertEquals('username', $request->getUser());
        $this->assertSame('', $request->getPassword());
        $this->assertFalse($request->isSecure());

        $request = \Illuminate\Support\Facades\Request::create('http://test.com/?foo');
        $this->assertEquals('/?foo', $request->getRequestUri());
        $this->assertEquals(array('foo' => ''), $request->query->all());

        ## assume rewrite rule: (.*) --> app/app.php ; app/ is a symlink to a symfony web/ directory
        $request = \Illuminate\Support\Facades\Request::create('http://test.com/apparthotel-1234', 'GET', array(), array(), array(),
            array(
        ...
        $this->assertEquals('http://test.com/apparthote \Illuminate\Support\Facades\Request::request->getUri());
    ...
    public function testCreateCheckPrecedence()
    {
     ...
     \Illuminate\Support\Facades\Request::ONTENT_TYPE' => 'application/json',
        ));
        ...
        $request = \Illuminate\Support\Facades\Request::create('http://thomas:pokemon@example.net:8080/?foo=bar', 'GET', array(), array(), array(), array(
            'HTTP_HOST' => 'example.com',
            'HTTPS' => 'on',
            'SERVER_PORT' => 443,
        ));
    ...
    public function testGetUri()
    {
        ...
        $request->initi \Illuminate\Support\Facades\Request::y(), array(), array(), array(), array(), $server);
        $this->assertEquals('http://host:8080/ba%20se/index_dev.php/foo%20ba \Illuminate\Support\Facades\Request::ery=string', $request->getUri());

        $server['PHP_AUTH_PW'] = 'symfony';
        $request->initialize(array(), array(), array() \Illuminate\Support\Facades\Request:: array(), $server);
        $this->assertEquals('http://host:8080/ba%20se/index_dev.php/foo%20bar/in+fo?query=string', $request-> \Illuminate\Support\Facades\Request::
    }
    ...
    public function testGetUriForPath()
    {
        ...
        $request = \Illuminate\Support\Facades\Request::create('http://test.com:90/foo?bar=baz');
        ...
        $request = \Illuminate\Support\Facades\Request::create('https://test.com:90/foo?bar=baz');
    ...
    public function testGetHost()
    {
        ...
        $this \Illuminate\Support\Facades\Request::uals('www.example.com', $request->getHost(), '->getHost() from Host Header with port number');

        // Server values
        $request->initialize(array(), array(), array(), array(), array(), array('SERVER_NAME' => 'www.example.com'));
        $this->assertEquals('www.example.com', $request->getHost(), '-> \Illuminate\Support\Facades\Request::from server name');

       \Illuminate\Support\Facades\Request::->initialize(array(), array(), array(), array(), array(), array('SERVER_NAME' => 'www.example.com', 'HTTP_HOST' => 'www.host.com'));
        $this->assertEquals('www.host.com', $request->getHost(), '->getHost() value from Host header has priority over SERVER_NAME ');
    }

    public function testGetPort()
    {
        $request = \Illuminate\Support\Facades\Request::create('http://example.com', 'GET', array(), array(), array(), array(
            'HTTP_X_FORWARDED_PROTO' => 'https',
   \Illuminate\Support\Facades\Request::'HTTP_X_FORWARDED_PORT' => '443',
        ));
        $port = $request->getPort();

        $this->assertEquals(80, $port, 'Without trusted proxies FORWARDED_PROTO and FORWARDED_PORT are ignored.');

        \Illuminate\Support\Facades\Request::setTrustedProxies(array('1.1.1.1'));
        $request = \Illuminate\Support\Facades\Request::create('http://example.com', 'GET', array(), array(), array(), array(
            'HTTP_X_FORWARDED_PROTO' => 'https',
            'HTTP_X \Illuminate\Support\Facades\Request::_PORT' => '8443',
        ));
        ...
        $request = \Illuminate\Support\Facades\Request::create('http://example.com', 'GET', array(), array(), array(), array(
            'HTTP_X_FORWARDED_PROTO' => 'https' \Illuminate\Support\Facades\Request::));
   ...
   \Illuminate\Support\Facades\Request::        $this->assertEquals(80, $request->getPort(), 'If X_FORWARDED_PROTO is set to HTTP getPort() ignores trusted headers on untrusted connection.');
        $request->server->set('REMOTE_ADDR', '1.1.1.1');
        $this->assertEquals(80, $request->getPort(), 'If X_FORWARDED_PROTO is set to HTTP getPort() returns port of the original request.');

        $request = \Illuminate\Support\Facades\Request::create('http://example.com', 'GET', array(), array(), array(), array( \Illuminate\Support\Facades\Request::   'HTTP_X_FORWARDED_PROTO' => 'On',
        ));
        ...
        $request->server->set('REMOTE_ADDR', '1.1.1.1');
        $this->a \Illuminate\Support\Facades\Request::s(443, $request->getPort(), 'With only PROTO set and value is On, getPort() defaults to 443.');
        ...
        \Illuminate\Support\Facades\Request::setTrustedProxies(array());
    }
   ...
   \Illuminate\Support\Facades\Request::s->assertEquals('GET', $request->getMethod(), '->getMethod() returns an uppercased string');
        ...
        $request = new Request();
        $request->setMethod('PO \Illuminate\Support\Facades\Request::    $request->request->set('_method', 'purge');
        ...
        Request::enableHttpMethodParameterOverride();
        $this->assertEquals('PURGE', $request->getMethod(), '->getMethod() returns the method from _method if defined and POST');
    \Illuminate\Support\Facades\Request::->disableHttpMethodParameterOverride();
     ...
     \Illuminate\Support\Facades\Request::st = new Request();
        $request->setMethod('POST');
        $request->headers->set('X-HTTP-METHOD-OVERRIDE', 'delete');
     ...
     */
    public function testGetContentCantBeCall \Illuminate\Support\Facades\Request::hResources($first, $second)
    {
        $req = new Request();
    ...
    public function testCreateFromGlobals($method)
    {
        ...
        $request = Request::c \Illuminate\Support\Facades\Request:: \Illuminate\Support\Facades\Request::        $this->assertEquals('bar1', $request->query->get('foo1'), '::fromGlobals() uses values from $_GET');
        $this->assertEquals('bar2 \Illuminate\Support\Facades\Request::t->request->get('foo2'), '::fromGlobals() uses values from $_POST');
        ...
        \Illuminate\Support\Facades\Request::enableHttpMethodParameterOverrid \Illuminate\Support\Facades\Request::   $_POST['_method'] = $method;
        $_POST['foo6'] = 'bar6';
        $_SERVER['REQUEST_METHOD'] = 'PoSt';
        $request = \Illuminate\Support\Facades\Request::createFromGlobals();
        $this \Illuminate\Support\Facades\Request::uals($normalizedMethod, $request->getMethod());
    ...
    public function testHasPreviousSession()
    {
        ...
        $request->cookies->set('MOCKSESSID', 'foo \Illuminate\Support\Facades\Request::  $this->assertFalse($request->hasPreviousSession());
        $request->setSession(new Session(new MockArraySessionStorage()));
   ...
   \Illuminate\Support\Facades\Request::>setAccessible(true);
    ...
    {
        return array(
            array \Illuminate\Support\Facades\Request::oo', 'foo'),
    ...
    private function getRequestInstanceForClientIpTests($remoteAddr, $httpForwardedFor, $trustedProxies)
    {
     ...
     \Illuminate\Support\Facades\Request::ll !== $httpForwardedFor) {
            $server['HTTP_X_FORWARDED_FOR'] = $httpForwardedFor;
        }

        if ($trustedProxies) {
            \Illuminate\Support\Facades\Request::setTrustedProxies($trustedProxies);
        }

        $request->initialize(array(), array(), array(), array(), array(), $server);

    \Illuminate\Support\Facades\Request::n $request;
    }

    public function testTrustedProxies()
    {
        $request = \Illuminate\Support\Facades\Request::create('http://example.com/');
        $request->server->set('REMOTE_ADDR', '3.3.3.3');
        $request->headers->set('X_FORWARDED_FOR', '1.1.1.1, 2.2.2.2');
        $request->headers->set('X_FORWARDED_HOST', 'foo.example \Illuminate\Support\Facades\Request::.example.com:8080');
        $request->headers->set('X_FORWARDED_PROTO', 'https');
        $request->headers->set('X_FORWARDED_PORT', 443);
        $request->headers->set('X_MY_FOR', '3.3.3.3, 4.4.4.4');
        $request->headers->set('X_MY_HOST', 'my.example.com');
        $request->headers->set('X_MY_PROTO', 'http') \Illuminate\Support\Facades\Request::$request->headers->set('X_MY_PORT', 81);

        // no trusted proxies
        $this->assertEquals('3.3.3.3', $request->getClientIp());
        $this->assertEquals('example.com', $request->getHost());
        $this->assertEquals(80, $request->getPort());
        $this->assertFalse($re \Illuminate\Support\Facades\Request::ecure());

        // disabling proxy tr \Illuminate\Support\Facades\Request::     Request::setTrustedProxies(array());
  \Illuminate\Support\Facades\Request::is->assertEquals('3.3.3.3', $request->getCl \Illuminate\Support\Facades\Request::
        $this->assertEquals('example.com', $request->getHost());
        $this->assertEquals(80, $request->getPort());
        $this->assertFalse($request->isSecure());

        // trusted proxy via setTrustedProxies()
        \Illuminate\Support\Facades\Request::setTrustedProxies(array('3.3.3.3', '2.2.2.2'));
        $this->assertEquals('1.1.1.1', $re \Illuminate\Support\Facades\Request::ClientIp());
        $this->assert \Illuminate\Support\Facades\Request::al.example.com', $request->getHost() \Illuminate\Support\Facades\Request:: $this->assertEquals(443, $request-> \Illuminate\Support\Facades\Request::;
        $this->assertTrue($request->isSecure());

        // trusted proxy via setTrustedProxies()
        Request::setTrustedProxies(array('3.3.3.4', '2.2.2.2'));
        $this->assertEquals('3.3.3.3', $request->getClientIp());
        $this->assertEquals('example.com', $request->getHo \Illuminate\Support\Facades\Request::     $t \Illuminate\Support\Facades\Request::tEquals(80, $request->getPort());
        $this \Illuminate\Support\Facades\Request::lse($request->isSecure());

        // check vario \Illuminate\Support\Facades\Request::RDED_PROTO header values
        Request::setTrust \Illuminate\Support\Facades\Request::array('3.3.3.3', '2.2.2.2'));
        $request->headers->set('X_FORWARDED_PROTO', 'ssl');
        $this->assertTrue($request->isSecure());

        $request->headers->set('X_FORWARDED_PROTO', 'h \Illuminate\Support\Facades\Request::');
       \Illuminate\Support\Facades\Request::ssertTrue($request->isSecure());

        // custom header names
        Request::setTrustedHeaderName(Request::HEADER_CLIENT_IP, 'X_MY_FOR');
        Request::setTruste \Illuminate\Support\Facades\Request::e(Request: \Illuminate\Support\Facades\Request::IENT_HOST, 'X_MY_HOST');
        ...
        // disabling via \Illuminate\Support\Facades\Request::der names
    ...
    public function testSetTrustedProxiesInvalidHeaderName()
    {
        ...
        \Illuminate\Support\Facades\Request::setTrustedHeaderName('bogus name', 'X_MY_FOR');
    }
    ...
    {
        \Illuminate\Support\Facades\Request::create('http://example.com/');
        \Illuminate\Support\Facades\Request::getTrustedHeaderName('bogus name');
    }
    ...
    public function testIISRequestUri($headers, $server, $expectedRequestUri)
    {
        ...
        $subRequest = \Illuminate\Support\Facades\Request::create($subRequestUri, 'get', array(), array(), array(), $request->server->all());
    ...
    \Illuminate\Support\Facades\Request::   ),
            ...
            array(
                ...
                array(),
 \Illuminate\Support\Facades\Request::      '/foo/bar',
            ),
            array(
                array(),
                array(
            ...
            array(
                array(),
          \Illuminate\Support\Facades\Request::ay(
                    'ORIG_PATH_INFO' => '/foo/ba \Illuminate\Support\Facades\Request::          ),
                '/foo/bar',
            ),
            array(
                array(),
        ...
        \Illuminate\Support\Facades\Request::/foo \Illuminate\Support\Facades\Request::ar',
            ),
        );
    }
   ...
   \Illuminate\Support\Facades\Request::o trusted host set -> no host check
        $request->headers->set('host', 'evil.com');
        $this->assertEquals('evil.com', $request->getHost());

        // add a trusted domain and all its subdomains
        \Illuminate\Support\Facades\Request::setTrustedHosts(array('.*\.?trusted.com$'));

        // untrusted host
        $request->headers->set('host', \Illuminate\Support\Facades\Request::');
        try {
            $request->getHost();
