...
class RequestMatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMethod($requestMethod, $matcherMethod, $isMatch)
    {
        ...
        $request = \Illuminate\Support\Facades\Request::create('', $requestMethod);
    ...
    {
        $matcher = new RequestMatcher();
        $request = \Illuminate\Support\Facades\Request::create('', 'get', array(), array(), array(), array('HTTP_HOST' => 'foo.example.com'));
    ...
    public function testPath()
    {
        ...
        $request = \Illuminate\Support\Facades\Request::create('/admin/foo');
    ...
    {
        $matcher = new RequestMatcher();
        $request = \Illuminate\Support\Facades\Request::create('/en/login');
    ...
    {
        $matcher = new RequestMatcher();
        $request = \Illuminate\Support\Facades\Request::create('/admin/fo%20o');
