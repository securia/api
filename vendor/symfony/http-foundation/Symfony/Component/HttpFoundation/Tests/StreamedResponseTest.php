...
class StreamedResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $response = new StreamedResponse(function () { echo ' \Illuminate\Support\Facades\Request::        $request = Request::create('/');
    ...
    {
        $response = new StreamedR \Illuminate\Support\Facades\Request::nction () { echo 'foo'; });
