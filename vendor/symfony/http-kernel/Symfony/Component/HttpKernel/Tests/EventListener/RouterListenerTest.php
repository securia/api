...
class RouterListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function createGetResponseEventForUri($uri)
    {
        ...
        $request = \Illuminate\Support\Facades\Request::create($uri);
    ...
    {
        $kernel = $this->getMock('Symfony\Component\HttpKernel\HttpKernelInterface');
        $request = \Illuminate\Support\Facades\Request::create('http://localhost/');
    ...
    {
        $kernel = $this->getMock('Symfony\Component\HttpKernel\HttpKernelInterface');
        $request = \Illuminate\Support\Facades\Request::create('http://localhost/', 'post');
        $event = new GetResponseEvent($kernel, $request, HttpKernelInterface::MASTER_REQUEST);
        ...
        $kernel = $this->getMock('Symfony\Component\HttpKernel\HttpKernelInterface');
        $request = \Illuminate\Support\Facades\Request::create('http://localhost/', 'get');
