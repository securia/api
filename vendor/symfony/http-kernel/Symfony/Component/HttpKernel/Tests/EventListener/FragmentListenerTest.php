...
class FragmentListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('http://example.com/foo?_path=foo%3Dbar%26_controller%3Dfoo');
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('http://example.com/_fragment?_path=foo%3Dbar%26_controller%3Dfoo');
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('http://example.com/_fragment', 'POST');
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('http://example.com/_fragment', 'GET', array(), array(), array(), array('REMOTE_ADDR' => '10.0.0.1'));
    ...
    public function testWithSignature()
    {
        ...
        $request = \Illuminate\Support\Facades\Request::create($signer->sign('http://example.com/_fragment?_path=foo%3Dbar%26_controller%3Dfoo'), 'GET', array(), array(), array(), array('REMOTE_ADDR' => '10.0.0.1'));
