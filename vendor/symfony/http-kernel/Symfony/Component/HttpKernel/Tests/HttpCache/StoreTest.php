...
class StoreTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->request = \Illuminate\Support\Facades\Request::create('/');
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('/foo');
    ...
    {
        $request = \Illuminate\Support\Facades\Request::create('/test', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
    ...
    public function testCanonizesUrlsForCacheKeys()
    {
        ...
        $hitsReq = \Illuminate\Support\Facades\Request::create($path);
        $missReq = \Illuminate\Support\Facades\Request::create('/test?p=x');
    ...
    {
        $req = \Illuminate\Support\Facades\Request::create('/test');
    ...
    {
        $req1 = \Illuminate\Support\Facades\Request::create('/test', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
        $req2 = \Illuminate\Support\Facades\Request::create('/test', 'get', array(), array(), array(), array('HTTP_FOO' => 'Bling', 'HTTP_BAR' => 'Bam'));
    ...
    public function testStoresMultipleResponsesForEachVaryCombination()
    {
        ...
        $req3 = \Illuminate\Support\Facades\Request::create('/test', 'get', array(), array(), array(), array('HTTP_FOO' => 'Baz', 'HTTP_BAR' => 'Boom'));
    ...
    public function testOverwritesNonVaryingResponseWithStore()
    {
        ...
        $req3 = \Illuminate\Support\Facades\Request::create('/test', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
        $res3 = new Response('test 3', 200, array('Vary' => 'Foo Bar'));
    ...
    {
        $req = \Illuminate\Support\Facades\Request::create('/test', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
    ...
    protected function storeSimpleEntry($path = null, $headers = array())
    {
        ...
        $this->request = \Illuminate\Support\Facades\Request::create($path, 'get', array(), array(), array(), $headers);
