...
class RoutableFragmentRendererTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals($uri, $this->callGenerateFragmentUriMethod($controller, \Illuminate\Support\Facades\Request::create('/')));
    }
    ...
    {
        $this->assertEquals('http://localhost'.$uri, $this->callGenerateFragmentUriMethod($controller, \Illuminate\Support\Facades\Request::create('/'), true));
    }
    ...
    {
        $this->callGenerateFragmentUriMethod($controller, \Illuminate\Support\Facades\Request::create('/'));
    }
