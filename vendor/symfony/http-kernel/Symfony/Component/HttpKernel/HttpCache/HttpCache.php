...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
            ...
            try {
                ...
                foreach (array('Location', 'Content-Location') as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \Illuminate\Support\Facades\Request::create($uri, 'get', array(), array(), array(), $request->server->all());
    ...
    protected function forward(Request $request, $catch = false, Response $entry = null)
    {
        ...
        if (!in_array('1 \Illuminate\Support\Facades\Request:: $trustedProxies = Request::getTrustedProxies())) {
 \Illuminate\Support\Facades\Request::  $trustedProxies[] = '127.0.0.1';
