...
class InlineFragmentRenderer extends RoutableFragmentRenderer
{
    ...
    public function render($uri, Request $request, array $options = array())
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Response::closeOutputBuffers($level, false);
    ...
    protected function createSubRequest($uri, Request $request)
    {
        ...
        try {
            if ($trustedHeaderName = \Illuminate\Support\Facades\Request::getTrustedHeaderName(Request::HEADER_CLIENT_IP)) {
        ...
        $subRequest = \Illuminate\Support\Facades\Request::create($uri, 'get', array(), $cookies, array(), $server);
