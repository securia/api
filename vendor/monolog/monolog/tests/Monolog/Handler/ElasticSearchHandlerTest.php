...
class ElasticSearchHandlerTest extends TestCase
{
    ...
    public function testHandleIntegration()
    {
        ...
        $client->request("/{$this->options['index']}", \Illuminate\Support\Facades\Request::DELETE);
    }
    ...
    {
        $resp = $client->request("/{$index}/{$type}/{$documentId}", \Illuminate\Support\Facades\Request::GET);
        $data = $resp->getData();
